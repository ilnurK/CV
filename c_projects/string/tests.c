...
#line 21
  ...
  ck_assert_int_eq(s21_memcmp(str1, "1234o567", 10),
                   memcmp(str1, "1234o567", 10));
  ck_assert_int_eq(s21_memcmp("", "", 3), memcmp("", "", 3));
  ck_assert_int_eq(s21_memcmp("1234567", "1234567", 7),
                   memcmp("1234567", "1234567", 7));
}
END_TEST
...
#line 30
  ...
  for (s21_size_t i = 0; i <= strlen(src); i++) {
    char dest1[] = "Two heads are better than one.",
         dest2[] = "Two heads are better than one.";
...
#line 89
  ...
  ck_assert_pstr_eq(strncpy(dest5, src3, strlen(src3)),
                    s21_strncpy(dest6, src3, strlen(src3)));
  char dest7[50] = "";
  char dest8[50] = "";
  char src4[] = "Where there's a will, there's a way.";
  ck_assert_pstr_eq(strncpy(dest7, src4, strlen(src4) + 10),
                    s21_strncpy(dest8, src4, strlen(src4) + 10));
  char dest9[50] = "012345";
  char dest10[50] = "012345";
  char src5[] = "-+=&^%$#@!&*()_";
  ck_assert_pstr_eq(strncpy(dest9, src5, strlen(src5)),
                    s21_strncpy(dest10, src5, strlen(src5)));
}
END_TEST
...
#line 136
  ...
  ck_assert_int_eq(s21_strlen("Still waters\0 run deep"),
                   strlen("Still waters\0 run deep"));
}
END_TEST

START_TEST(twelve) {
#line 143
  ck_assert_pstr_eq(s21_strpbrk("Hello there", "there"),
                    strpbrk("Hello there", "there"));
  ck_assert_pstr_eq(s21_strpbrk("\n", "\n"), strpbrk("\n", "\n"));
  ck_assert_pstr_eq(s21_strpbrk("\0", "\0"), strpbrk("\0", "\0"));
  ck_assert_pstr_eq(s21_strpbrk("dg", "askdljglag"),
                    strpbrk("dg", "askdljglag"));
...
#line 158
  ...
  ck_assert_pstr_eq(s21_strstr(str, "Galya, u nas otmena!"),
                    strstr(str, "Galya, u nas otmena!"));
...
#line 168
  ...
  // ck_assert_pstr_eq(s21_strtok("When pigs fly", "When pigs fly"),
  // strtok("When pigs fly", "When pigs fly"));
}
END_TEST
...
#line 212
  ...
  ck_assert_pstr_eq(
      s21_insert(src, str, 30),
      "You can lead a horse to water, but you can’t make him drink it.");
  ck_assert_pstr_eq(
      s21_insert(src, str, 0),
      " but you can’t make him drink it.You can lead a horse to water,");
  ck_assert_pstr_eq(
      s21_insert(src, str, 8),
      "You can  but you can’t make him drink it.lead a horse to water,");
  ck_assert_pstr_eq(s21_insert("", str, 0),
...
#line 251
  for (int i = -4096; i <= 4096; i++) {
    ...
    char str2[1000];
    char *str3 =
        "%d abc %5d DEF %-10d %.7d %2.5d %-34.12d %.d %-.d %-.5d %0d %0.0d "
        "%8.0d %0.5d";
    ck_assert_int_eq(
        sprintf(str1, str3, i, i, i, i, i, i, i, i, i, i, i, i, i),
        s21_sprintf(str2, str3, i, i, i, i, i, i, i, i, i, i, i, i, i));
    ck_assert_pstr_eq(str1, str2);
    char *str4 =
        "%+14.5d %+.d %+d %+.2d %+.6d %+.0d %+13.0d %+0d !%+0.0d! %+8.0d "
        "%+0.5d";
    ck_assert_int_eq(
        sprintf(str1, str4, i, i, i, i, i, i, i, i, i, i, i, i, i),
        s21_sprintf(str2, str4, i, i, i, i, i, i, i, i, i, i, i, i, i));
    ck_assert_pstr_eq(str1, str2);
    char *str5 = "%2.21d %0.32d %-5.28d %+-.30d %-+7.40d %*d %.*d %*.*d";
    ck_assert_int_eq(
        sprintf(str1, str5, i, i, i, i, i, 25, i, 32, i, -7, 1, i),
...
#line 269
  for (unsigned int u = 0; u <= 4096; u++) {
    ...
    char str2[1000];
    char *str3 =
        "%u abc %5u DEF %-10u %.7u %2.5u %-34.12u %.u %-.u %-.5u %0u %0.0u "
        "%8.0u %0.5u";
    ck_assert_int_eq(
        sprintf(str1, str3, u, u, u, u, u, u, u, u, u, u, u, u, u),
        s21_sprintf(str2, str3, u, u, u, u, u, u, u, u, u, u, u, u, u));
    ck_assert_pstr_eq(str1, str2);
    char *str4 = "%2.21u %0.32u %-5.28u %+-.30u %-+7.40u %*u %.*u %*.*u";
    ck_assert_int_eq(
        sprintf(str1, str4, u, u, u, u, u, 25, u, 32, u, -7, 1, u),
...
#line 283
  ...
  for (int x = 0; x < 2; x++) {
    ...
    char str2[1000];
    char *str3 =
        "%li abc %5hi DEF %-10i %.7i %2.5i %-34.12i %.i %-.i %-.5i %0i %0.0i "
        "%8.0i %0.5i";
    ck_assert_int_eq(
        sprintf(str1, str3, li, i, i, i, i, i, i, i, i, i, i, i, i),
...
#line 297
  ...
  ck_assert_int_eq(sprintf(strG1, strG3, G, G, G, G, G1, G2, G3),
                   s21_sprintf(strG2, strG3, G, G, G, G, G1, G2, G3));
...
#line 311
  char str1[100];
  char str2[100];
  ck_assert_int_eq(sprintf(str1, "%%test%% test%%%% test%%"),
                   s21_sprintf(str2, "%%test%% test%%%% test%%"));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
#line 317
  ...
  ck_assert_int_eq(sprintf(str1, str5, "never", "value", "well"),
                   s21_sprintf(str2, str5, "never", "value", "well"));
  ck_assert_pstr_eq(str1, str2);
  char *str6 = "We %10s know the %-7s of water till the %1s is dry";
  ck_assert_int_eq(sprintf(str1, str6, "never", "value", "well"),
                   s21_sprintf(str2, str6, "never", "value", "well"));
  ck_assert_pstr_eq(str1, str2);
  char *str7 = "We %1.5s know the %-10.12s of water till the %.2s is %-.6s";
  ck_assert_int_eq(sprintf(str1, str7, "never", "value", "well", "dry"),
                   s21_sprintf(str2, str7, "never", "value", "well", "dry"));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
#line 334
  ...
  char str2[1000];
  char *str3 =
      "%f, abc%2f def %17fghi %-7f %-2.8f 13459%-.15f %.1f %14.5f %.f %f %.2f "
      "%.7f %.0f %13.0f %0f %0.0f %0.12f %-.7f %-6f";
  ck_assert_int_eq(sprintf(str1, str3, x, x, x, x, x, x, x, x, x, x, x, x, x, x,
                           x, x, x, x, x),
                   s21_sprintf(str2, str3, x, x, x, x, x, x, x, x, x, x, x, x,
                               x, x, x, x, x, x, x));
  ck_assert_pstr_eq(str1, str2);
  char *str4 =
      "%+f, abc%+2f def %+17fghi %+-7f %-+2.8f 13459%+-.15f %+.1f %+14.5f %+.f "
      "%+f %+.2f %+.7f %+.0f %+13.0f %+0f %+0.0f %+0.12f %+-.7f %-+6f";
  ck_assert_int_eq(sprintf(str1, str4, x, x, x, x, x, x, x, x, x, x, x, x, x, x,
                           x, x, x, x, x),
                   s21_sprintf(str2, str4, x, x, x, x, x, x, x, x, x, x, x, x,
                               x, x, x, x, x, x, x));
  ck_assert_pstr_eq(str1, str2);
  ck_assert_int_eq(sprintf(str1, str3, y, y, y, y, y, y, y, y, y, y, y, y, y, y,
                           y, y, y, y, y),
                   s21_sprintf(str2, str3, y, y, y, y, y, y, y, y, y, y, y, y,
                               y, y, y, y, y, y, y));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
#line 350
  ...
  long int num;
  ck_assert_int_eq(s21_sscanf(src_scanf, "%ld", &num),
                   sscanf(src_scanf, "%ld", &num));
  char src_scanf1[100] = "999991111135912x6";
  int num1;
  ck_assert_int_eq(s21_sscanf(src_scanf1, "%3d", &num1),
                   sscanf(src_scanf1, "%3d", &num1));
  char src_scanf2[100] = "9912x6";
  short int num2;
  ck_assert_int_eq(s21_sscanf(src_scanf2, "%hd", &num2),
                   sscanf(src_scanf2, "%hd", &num2));
  char src_scanf3[100] = "999991111135912x6";
  ck_assert_int_eq(s21_sscanf(src_scanf3, "%99d", &num1),
                   sscanf(src_scanf3, "%99d", &num1));
  char src_scanf4[100] = "99999111 1135912x6";
  long int num3;
  ck_assert_int_eq(s21_sscanf(src_scanf4, "%ld %ld", &num, &num3),
                   sscanf(src_scanf4, "%ld %ld", &num, &num3));
  ck_assert_int_eq(s21_sscanf("", "%ld", &num), sscanf("", "%ld", &num));
  ck_assert_int_eq(s21_sscanf("", "%ld %ld", &num, &num3),
                   sscanf("", "%ld %ld", &num, &num3));
  char specs[] = "%ldabc dd %c %s";
  char c;
  char str[100];
  char src_scanf5[100] = "12abc dd \' yahoo";
  ck_assert_int_eq(s21_sscanf(src_scanf5, specs, &num, &c, str),
                   sscanf(src_scanf5, specs, &num, &c, str));
  char src_scanf6[100] = "12 \' yahoo";
  char specs2[] = "%ldddd %c %s";
  ck_assert_int_eq(s21_sscanf(src_scanf6, specs2, &num, &c, str),
                   sscanf(src_scanf6, specs, &num, &c, str));
  char src_scanf7[100] = "-0x2f16vb dd \' yahoo";
  char specs3[] = "%ldvb dd %c %s";
  ck_assert_int_eq(s21_sscanf(src_scanf7, specs3, &num, &c, str),
                   sscanf(src_scanf7, specs3, &num, &c, str));
  char src_scanf8[100] = "-00001234567890vb dd \' yahoo";
  char specs4[] = "%70ldvb dd %c %s";
  ck_assert_int_eq(s21_sscanf(src_scanf8, specs4, &num, &c, str),
                   sscanf(src_scanf8, specs4, &num, &c, str));
  char src_scanf9[100] = "-123.4567890vb dd \' yahoo";
  char specs5[] = "%070lfvb dd %c %s";
  double num4;
  ck_assert_int_eq(s21_sscanf(src_scanf9, specs5, &num4, &c, str),
                   sscanf(src_scanf9, specs5, &num4, &c, str));
}
END_TEST
...
#line 386
  ...
  int n1, n2, d1, d2;
  ck_assert_int_eq(sscanf(str, "%d%n", &d1, &n1),
                   s21_sscanf(str, "%d%n", &d2, &n2));
