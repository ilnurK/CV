...
#line 38
  ...
  ck_assert(fabsl(s21_tan(-3 * S21_PI / 2.3) - tan(-3 * S21_PI / 2.3)) <
            S21_EPS);
  // ck_assert(tan(-55 * S21_PI / 2.115) - s21_tan(-55 * S21_PI / 2.115)<
  // S21_EPS);
