...
"for ../grep/s21_grep.c ../grep/s21_grep.h ../grep/Makefile VAR"
"for ../grep/s21_grep.c VAR"
"-e for -e ^int ../grep/s21_grep.c ../grep/s21_grep.h ../grep/Makefile VAR"
"-e for -e ^int ../grep/s21_grep.c VAR"
"-e regex -e ^print ../grep/s21_grep.c VAR -f test_ptrn_grep.txt"
"-e while -e void ../grep/s21_grep.c ../grep/Makefile VAR -f test_ptrn_grep.txt"
)
...
"-no ing test_6_grep.txt"
"-e ing -e as -e the -e not -e is test_6_grep.txt"
"-c -e int test_1_grep.txt"
...
# 2 параметра
for var1 in v c n h o
do
    for var2 in v c n h o
    do
        if [ $var1 != $var2 ]
        then
            for i in "${tests[@]}"
